...
describe('Inventory reports and supplier regression coverage', () => {
  ...
  it('rejects invalid supplier email 2', async () => {
    const dto = plainToInstance(CreateSupplierDto, {
      supplierNumber: 'SUP-BAD-2',
      name: 'Supplier 2',
      email: 'bad-email-2',
    });
    const errors = await validate(dto);
  ...
  it('rejects invalid supplier email 3', async () => {
    const dto = plainToInstance(CreateSupplierDto, {
      supplierNumber: 'SUP-BAD-3',
      name: 'Supplier 3',
      email: 'bad-email-3',
    });
    const errors = await validate(dto);
  ...
  it('rejects invalid supplier email 4', async () => {
    const dto = plainToInstance(CreateSupplierDto, {
      supplierNumber: 'SUP-BAD-4',
      name: 'Supplier 4',
      email: 'bad-email-4',
    });
    const errors = await validate(dto);
  ...
  it('rejects invalid supplier email 5', async () => {
    const dto = plainToInstance(CreateSupplierDto, {
      supplierNumber: 'SUP-BAD-5',
      name: 'Supplier 5',
      email: 'bad-email-5',
    });
    const errors = await validate(dto);
  ...
  it('rejects invalid supplier email 6', async () => {
    const dto = plainToInstance(CreateSupplierDto, {
      supplierNumber: 'SUP-BAD-6',
      name: 'Supplier 6',
      email: 'bad-email-6',
    });
    const errors = await validate(dto);
  ...
  it('rejects invalid supplier email 7', async () => {
    const dto = plainToInstance(CreateSupplierDto, {
      supplierNumber: 'SUP-BAD-7',
      name: 'Supplier 7',
      email: 'bad-email-7',
    });
    const errors = await validate(dto);
  ...
  it('accepts supplier query status INACTIVE case 1', async () => {
  ...
  it('accepts supplier query status ACTIVE case 2', async () => {
    const dto = plainToInstance(GetSuppliersQueryDto, {
      page: '2',
      limit: '20',
      search: 'supplier',
  ...
  it('accepts supplier query status ACTIVE case 4', async () => {
    const dto = plainToInstance(GetSuppliersQueryDto, {
      page: '4',
      limit: '20',
      search: 'supplier',
  ...
  it('accepts supplier query status INACTIVE case 5', async () => {
    const dto = plainToInstance(GetSuppliersQueryDto, {
      page: '5',
      limit: '20',
      search: 'supplier',
  ...
  it('accepts supplier query status ACTIVE case 6', async () => {
    const dto = plainToInstance(GetSuppliersQueryDto, {
      page: '6',
      limit: '20',
      search: 'supplier',
  ...
  it('accepts supplier query status INACTIVE case 7', async () => {
    const dto = plainToInstance(GetSuppliersQueryDto, {
      page: '7',
      limit: '20',
      search: 'supplier',
